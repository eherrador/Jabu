...
[assembly: OwinStartup(typeof(WebAppMvcJabu.Startup))]
    ...
    public class Startup
    {
        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                ExpireTimeSpan = TimeSpan.FromMinutes(double.Parse(ConfigurationManager.AppSettings["TimeoutSessionExpire"].ToString())),
